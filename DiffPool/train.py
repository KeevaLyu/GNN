...
def train(dataset, model, args, same_feat=True, val_dataset=None, test_dataset=None, writer=None, mask_nodes=True):
...
def benchmark_task_val(args, writer=None, feat='node-label'):
    ...
    if feat == 'node-label' and 'label' in example_node:
    ...
    for i in range(10):
        ...
        if args.method == 'soft-assign':
            ...
            model = encoders.SoftPoolingGcnEncoder(
                ...
                bn=args.bn, dropout=args.dropout, linkpred=args.linkpred, args=args, assign_input_dim=assign_input_dim).cuda()
        # elif args.method == 'diffpool':
        #     print('Method: diffpool')
        #     model = encoder.DiffPool(
        #         input_dim,
        #         args.hidden_dim,
        #         args.output_dim,
        #         args.num_classes,
